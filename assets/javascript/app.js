...
$(document).ready(function () {
    ...
    var questions = [{
        ...
        choices: ["1 hour, 15 min and 15 seconds", "1 hour, 15 min and 30 seconds", "1 hour, 25 min and 45 seconds", "2 hour, 25 min and 13 seconds"]
    },
    ...
    function displayQuestion() {
        ...
        $(".input-group").append("<div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='one'  value='0'><p class='anwsers' id='anwser1'></p><input type='radio' name='one' value='1'><p class='anwsers' id='anwser2'></p><input type='radio' name='one'  value='1'><p class='anwsers' id='anwser3'></p><input type='radio' name ='one' value='1'> <p class='anwsers' id='anwser4'></p></div> </div>")
        ...
        $(".input-group2").append(" <div class='input-group-prepend'>  <div class='input-group-text rounded-0'> <input type='radio' name='two'  value='1'><p class='anwsers' id='anwser5'></p><input type='radio' name='two' value='0'><p class='anwsers' id='anwser6'></p><input type='radio' name='two'  value='1'><p class='anwsers' id='anwser7'></p><input type='radio' name ='two' value='1'> <p class='anwsers' id='anwser8'></p></div> </div>")
        ...
        $(".input-group3").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='three'  value='1'><p class='anwsers' id='anwser9'></p><input type='radio' name='three' value='1'><p class='anwsers' id='anwser10'></p><input type='radio' name='three'  value='1'><p class='anwsers' id='anwser11'></p><input type='radio' name ='three' value='0'> <p class='anwsers' id='anwser12'></p></div> </div>")
        ...
        $(".input-group4").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='four'  value='1'><p class='anwsers' id='anwser13'></p><input type='radio' name='four' value='1'><p class='anwsers' id='anwser14'></p><input type='radio' name='four'  value='0'><p class='anwsers' id='anwser15'></p><input type='radio' name ='four' value='1'> <p class='anwsers' id='anwser16'></p></div> </div>")
        ...
        $(".input-group5").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='five'  value='0'><p class='anwsers' id='anwser17'></p><input type='radio' name='five' value='1'><p class='anwsers' id='anwser18'></p><input type='radio' name='five'  value='1'><p class='anwsers' id='anwser19'></p><input type='radio' name ='five' value='1'> <p class='anwsers' id='anwser20'></p></div> </div>")
        ...
        $(".input-group6").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='six'  value='0'><p class='anwsers' id='anwser21'></p><input type='radio' name='six' value='1'><p class='anwsers' id='anwser22'></p><input type='radio' name='six'  value='1'><p class='anwsers' id='anwser23'></p><input type='radio' name ='six' value='1'> <p class='anwsers' id='anwser24'></p></div> </div>")
...
//question7
        ...
        $(".input-group7").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='seven'  value='1'><p class='anwsers' id='anwser25'></p><input type='radio' name='seven' value='0'><p class='anwsers' id='anwser26'></p><input type='radio' name='seven'  value='1'><p class='anwsers' id='anwser27'></p><input type='radio' name ='seven' value='1'> <p class='anwsers' id='anwser28'></p></div> </div>")
        ...
        $(".input-group8").append(" <div class='input-group-prepend'> <div class='input-group-text rounded-0'> <input type='radio' name='eight'  value='0'><p class='anwsers' id='anwser29'></p><input type='radio' name='eight' value='1'><p class='anwsers' id='anwser30'></p><input type='radio' name='eight'  value='1'><p class='anwsers' id='anwser31'></p><input type='radio' name ='eight' value='1'> <p class='anwsers' id='anwser32'></p></div> </div>")
